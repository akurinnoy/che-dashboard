...
export class BackupTab extends React.PureComponent<Props> {
  ...
  private renderError(error: string): React.ReactElement {
    return (
      <PageSection variant={PageSectionVariants.light}>
        <Alert variant={AlertVariant.danger} title="Failed to load backup information" isInline>
          {error}
        </Alert>
      </PageSection>
    );
  ...
  private renderBackupInfo(backupInfo: BackupInfo): React.ReactElement {
    const { status, lastBackupTime, backupImageUrl, nextScheduledBackup, error: backupError } =
      backupInfo;
        ...
        <CardBody>
          <DescriptionList isHorizontal>
            ...
            <DescriptionListGroup>
              ...
              <DescriptionListDescription>
                {nextScheduledBackup
                  ? this.formatLastBackupTime(nextScheduledBackup)
                  : 'Default schedule'}
              </DescriptionListDescription>
            </DescriptionListGroup>
          </DescriptionList>
