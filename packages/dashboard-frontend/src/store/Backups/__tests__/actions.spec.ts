...
describe('Backup Actions', () => {
  ...
  describe('fetchBackupList', () => {
    ...
    it('should fetch backup list successfully', async () => {
      ...
      expect(mockedBackupApi.listBackups).toHaveBeenCalledWith(namespace, undefined, undefined, undefined);
    ...
    it('should fetch backup list with workspace name filter', async () => {
      ...
      expect(mockedBackupApi.listBackups).toHaveBeenCalledWith(namespace, workspaceName, undefined, undefined);
