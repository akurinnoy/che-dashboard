...
import * as devworkspaceApiClient from '@/services/backend-client/devWorkspaceApi';
...
export const actionCreators = {
  ...
  restoreFromBackup:
    (namespace: string, workspaceName: string, backupImageUrl: string): AppThunk =>
    async dispatch => {
      const { devWorkspace } = await devworkspaceApiClient.restoreWorkspace(
        namespace,
        workspaceName,
        backupImageUrl,
      );
