...
class WorkspaceStepInitialize extends ProgressStep<Props, State> {
  ...
  protected async runStep(): Promise<boolean> {
    console.log('>>> WorkspaceStepInitialize start');
    ...
    console.log('>>> WorkspaceStepInitialize done');
...
export default connector(WorkspaceStepInitialize);
