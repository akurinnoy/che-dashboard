...
import {
  getEnvironment,
  isDevEnvironment,
} from '../../../../../../../services/helpers/environment';
...
class StepFetchDevfile extends AbstractLoaderStep<Props, State> {
  ...
  render(): React.ReactElement {
    const { currentStepIndex, loaderSteps, showToastAlert } = this.props;
    ...
    return (
      <>
        <LoaderAlert alertItem={alertItem} isToast={showToastAlert} />
        <LoaderProgress currentStepId={currentStepId} loaderSteps={steps} />
      </>
    );
  }
}
